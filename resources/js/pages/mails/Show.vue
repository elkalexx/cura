...
<template>
    ...
    <div class="flex h-[calc(100vh-4rem)] flex-col p-4 sm:p-6 lg:p-8">
        <div class="flex flex-1 flex-col gap-6 overflow-hidden md:flex-row">
                        ...
                        <div class="flex items-start justify-between gap-4">
                            <div>
                                ...
                                <p class="text-sm text-muted-foreground">
                                    From: {{ props.message.sender_participant.contact.display_name }} &lt;{{
                                        props.message.sender_participant.contact.email
                                    }}&gt;
                                </p>
                            </div>
            ...
            <div class="flex w-full flex-col md:w-1/2">
                <form @submit.prevent="replyEmail" class="flex flex-1 flex-col">
                    <Card class="flex flex-1 flex-col">
                        <CardHeader class="border-b">
